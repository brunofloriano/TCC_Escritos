...
na qual $P_i$ é o vetor de posição do COG até a i-ésima pata e $e_i$ é o vetor unitário que circunda o polígono de suporte na direção horária. Estes parâmetros podem ser observados com maior clareza na Figura \ref{fig:dinamico1}.
...
em que $\tau$ é o torque aplicado na dobradiça do quadril, $k_p$ e $k_v$ são ganhos, $\phi$ é a inclinação do corpo, $\phi_d$ é a inclinação desejada do corpo e $\dot{\phi}$ é a taxa de variação da inclinação do corpo.
