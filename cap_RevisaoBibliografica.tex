...
\begin{figure}[h]
	...
	\caption{Polígonos de suporte de um robô quadrúpede durante sua caminhada (Fonte: \cite{article:mcghee:1968})}
	\label{fig:poligonos}
\end{figure}
...
\begin{figure} [t]
	...
	\caption{Margens de Estabilidade Longitudinal e de Caranguejo (Fonte: \cite{book})}
...
\begin{figure} [h]
	...
	\caption{Esquemático dos parâmetros geométricos durante o tombo (Fonte: \cite{book})}
	\label{fig:dinamico2}
\end{figure}
...
\begin{figure} [t]
	...
	\caption{Pernas virtuais para cada marcha (Fonte: \cite{article:raibert:1986})}
...
\begin{figure} [!b]
	...
	\caption{Vistas do quadrúpede com 6 graus de liberdade (Fonte: \cite{article:li:2014})}
	\label{fig:slip}
\end{figure}
...
\begin{figure} [t]
	...
	\caption{Modelo de quadrúpede apoiado em pernas diagonais (Fonte: \cite{article:meng:2015})}
	\label{fig:balanco1}
\end{figure}
...
\begin{figure} [t]
	...
	\caption{Diagrama de blocos do sistema de controle de equilíbrio e trajetória (Fonte: \cite{article:won:2009})}
	\label{fig:lar3}
\end{figure}
...
\begin{figure}[b]
	...
	\caption{Parâmetros de um quadrúpede em instabilidade (Fonte: \cite{article:won:2009})}
	\label{fig:lar4}
\end{figure}
...
\begin{figure} [!b]
	...
	\caption{Algoritmo para controle de estabilidade utilizando o LAR (Fonte: \cite{article:won:2009})}
	\label{fig:lar5}
\end{figure}
...
\begin{figure} [b]
	...
	\caption{Sistema de realimentação para controle de marcha e de postura (Fonte: \cite{article:runbin:2013})}
