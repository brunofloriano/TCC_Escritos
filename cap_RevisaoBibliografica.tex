...
Por conseguinte, utilizando o conceito de pernas virtuais, podemos estender a equação (\ref{eq:onelegged}) para o movimento de quadrupedes que, por sua vez, possuem duas pernas virtuais e pode se mover em duas dimensões, obtendo, dessa forma a expressão
