...
\section{Conclusão}
Neste capítulo, foram apresentados os principais trabalhos estudados sobre o tema de controle de equilíbrio de robôs quadrúpedes. Apresentou-se desenvolvimentos concebidos desde o início do estudo deste tema até o cenário atual. Por esse motivo, várias abordagens diferentes foram estudadas, incluindo métodos empíricos, dinâmicos, cinemáticos e geométricos.

A metodologia que será aplicada no desenvolvimento deste trabalho, como será melhor abordado no capítulo \ref{CapDesenvolvimento}, apresenta uma abordagem composta, principalmente, por elementos cinemáticos. Além disso, a componente empírica também terá um foco fundamental ao longo do desenvolvimento do projeto. Apesar de que o controle a ser implementado não considera fatores dinâmicos como torques e momentos, alguns dos conceitos utilizados nos trabalhos com estes modelos podem ser aplicados.

Neste sentido, o controle de estabilidade será realizado em grande parte com um controle de velocidades. Assim como em \cite{article:raibert:1986, article:won:2009,article:featherstone:2016}, a concepção inicial deste trabalho se baseou nas velocidades dos ângulos de rolagem e arfagem do corpo do robô para a caracterização do distúrbio gerador da instabilidade e, consequentemente, do seu uso para a determinação das respostas necessárias para a devida correção. Alguns destes trabalhos (e.g. \cite{article:raibert:1986, article:won:2009}) fazem tal correção através da aplicação de torques. Neste caso, porém, esta será realizada pela imposição de velocidades em cada junta, de forma proporcional à perturbação sofrida.
