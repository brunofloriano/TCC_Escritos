...
Da mesma forma, a correção do movimento de arfagem, como pode ser observado na Fig. \ref{fig:sincronia_pitch}(a), pode ser feita com as patas da frente (motores 8, 9, 11 e 12, com linhas horizontais), com um ganho $K_{F}$, ou com as patas de trás (motores 2, 3, 5 e 6, com linhas verticais), com um ganho $K_{B}$\footnotemark.
...
\begin{figure} [t]
	\centering
	\includegraphics[width=0.7\textwidth]{Figuras/robo4b}
...
\begin{figure}[b]
	\centering
	\mbox{
		\subfigure[Sincronia por patas]{\includegraphics[width=0.4\textwidth]{Figuras/robo5b}}\quad\quad
		\subfigure[Sincronia pelo tipo de junta]{\includegraphics[width=0.4\textwidth]{Figuras/robo3b}}}
