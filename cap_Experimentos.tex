...
Por fim, pode-se observar que o valor médio das velocidades obtidas encontra-se na ordem de $10^{-3}$ e $10^{-4}$ graus/s e, dessa forma, reduzidos o bastante para serem considerados próximos de zero. Como será visto mais adiante, um distúrbio no sentido de rolagem, por exemplo, permanece na ordem de 50 a 500 graus/s.
...
\begin{figure}[!t]
	\centering
	\mbox{
		\subfigure[Ângulos medidos]{\includegraphics[width=0.5\textwidth]{Figuras/Modo_velocidade1b}}\quad\quad
		\subfigure[Velocidade de Rolagem e dos seus motores]{\includegraphics[width=0.5\textwidth]{Figuras/Modo_velocidade2b}}}
	\subfigure[Velocidade de Arfagem e dos seus motores]{\includegraphics[width=0.5\textwidth]{Figuras/Modo_velocidade3b}}
...
\begin{figure}[!t]
	\centering
	\mbox{
		\subfigure[Ângulos medidos]{\includegraphics[width=0.5\textwidth]{Figuras/Modo_posicao1b}}\quad\quad
		\subfigure[Velocidade de Rolagem e dos seus motores]{\includegraphics[width=0.5\textwidth]{Figuras/Modo_posicao2b}}}
		\subfigure[Velocidade de Arfagem e dos seus motores]{\includegraphics[width=0.5\textwidth]{Figuras/Modo_posicao3b}}
...
\begin{figure}[!b]
	\centering
	\mbox{
		\subfigure[Ângulos medidos]{\includegraphics[width=0.45\textwidth]{Figuras/Queda_Roll_R_1b}}\quad\quad
		\subfigure[Velocidade de Rolagem e dos seus motores]{\includegraphics[width=0.45\textwidth]{Figuras/Queda_Roll_R_2b}}}
...
\begin{figure}[!b]
	\centering
	\mbox{
		\subfigure[Ângulos medidos]{\includegraphics[width=0.4\textwidth]{Figuras/Queda_Roll_R_3b}}\quad\quad
		\subfigure[Velocidade de Rolagem e dos seus motores]{\includegraphics[width=0.4\textwidth]{Figuras/Queda_Roll_R_4b}}}
		\subfigure[Velocidade de Arfagem e dos seus motores]{\includegraphics[width=0.4\textwidth]{Figuras/Queda_Roll_R_5b}}
...
\begin{figure}[!b]
	\centering
	\mbox{
		\subfigure[Ângulos medidos]{\includegraphics[width=0.4\textwidth]{Figuras/Queda_Pitch_F_1b}}\quad\quad
		\subfigure[Velocidade de Arfagem e dos seus motores]{\includegraphics[width=0.4\textwidth]{Figuras/Queda_Pitch_F_2b}}}
	\subfigure[Velocidade de Arfagem e dos seus motores]{\includegraphics[width=0.4\textwidth]{Figuras/Queda_Pitch_F_3b}}
...
\begin{figure}[!b]
	\centering
	\mbox{
		\subfigure[Ângulos medidos]{\includegraphics[width=0.4\textwidth]{Figuras/Queda_Todos1b}}\quad\quad
		\subfigure[Velocidade de Arfagem e dos seus motores]{\includegraphics[width=0.4\textwidth]{Figuras/Queda_Todos2b}}}
		\subfigure[Velocidade de Arfagem e dos seus motores]{\includegraphics[width=0.4\textwidth]{Figuras/Queda_Todos3b}}
...
Para $\tau_p = 0,5$, as respostas dos motores podem ser visualizadas através da Figura \ref{fig:taup_0.5}. Nela, percebemos que o valor de maior tempo de resposta na direção da rolagem foi de 2,5 segundos. No entanto, para a arfagem percebeu-se que tal valor chegou a 9,1 segundos.
