...
\begin{figure}[t]
	...
	\mbox{
		...
		\subfigure[Velocidade de Arfagem e dos seus motores]{\includegraphics[width=0.3\textwidth]{Figuras/Queda_Roll_R_5}}}
...
\begin{figure} [t]
	\centering
	\includegraphics[width=0.5\textwidth]{Figuras/marcha1}
