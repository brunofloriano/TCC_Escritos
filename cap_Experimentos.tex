...
\begin{figure} [t]
	...
	\caption{Teste de marcha no sistema com paralelismo}
	\label{fig:marcha1}
\end{figure}
...
\begin{figure} [t]
	...
	\caption{Marcha do robô adicionada ao sistema com paralelismo}
	\label{fig:sequencia}
\end{figure}
